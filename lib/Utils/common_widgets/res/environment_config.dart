...
class EnvironmentConfig extends InheritedWidget {
  ...
  String get generalUrlBaseFlavour {
    ...
    switch (flavor) {
      ...
      case EnvironmentFlavor.prodDBPL:
        return "https://dbpl.plcms.net/api/";
      case EnvironmentFlavor.prodPJPL:
        return "https://pjpl.plcms.net/api/";
      case EnvironmentFlavor.prodUrjagati:
        return "https://urjagati.smartgasnet.com/api/";
      case EnvironmentFlavor.prodBJPL:
        return "https://bjpl.plcms.net/api/";
