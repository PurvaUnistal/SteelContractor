...
abstract class NDTRTEvent extends Equatable {}


class NDTRTPageLoadEvent extends NDTRTEvent {
  final BuildContext context;
  NDTRTPageLoadEvent({required this.context});
  @override
  // TODO: implement props
  List<Object> get props => [context];
}

class SearchBpNumberEvent extends NDTRTEvent {
  final BuildContext context;
...
class LoadMoreTableEvent extends NDTRTEvent {
  final BuildContext context;
  ...
  class SelectAllCheckBoxEvent extends NDTRTEvent {
...
class SelectRowIdCheckBoxEvent extends NDTRTEvent {
  final String itemId;
  final bool isSelected;
  final BuildContext context;
...
class ActivityApprovedEvent extends NDTRTEvent {
  final BuildContext context;
...
class ActivityRejectEvent extends NDTRTEvent {
  final BuildContext context;
...
class DownloadPdfEvent extends NDTRTEvent {
  final String url;
  final BuildContext context;
...
class ImageViewEvent extends NDTRTEvent {
  final String url;
  final BuildContext context;
...
class SelectTpiEvent extends NDTRTEvent {
