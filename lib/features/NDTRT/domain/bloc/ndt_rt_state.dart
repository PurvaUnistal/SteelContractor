...
abstract class NDTRTState extends Equatable {
  const NDTRTState();
}

final class NDTRTInitial extends NDTRTState {
  @override
  List<Object> get props => [];
}

class NDTRTPageLoadState extends NDTRTState {
  @override
  List<Object> get props => [];
}

class NDTRTLoadedDataState extends NDTRTState {
  final bool isLoader;
