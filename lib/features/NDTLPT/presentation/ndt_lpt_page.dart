...
import 'package:steel_contractor/features/NDTLPT/domain/bloc/ndt_lpt_event.dart';
import 'package:steel_contractor/features/NDTLPT/domain/bloc/ndt_lpt_state.dart';

class NDTLPTPage extends StatefulWidget {
  const NDTLPTPage({super.key});

  @override
  State<NDTLPTPage> createState() => _NDTLPTPageState();
}

class _NDTLPTPageState extends State<NDTLPTPage> {
  ScrollController _horizontalScrollController = ScrollController();
  ScrollController _verticalScrollController = ScrollController();

  @override
  void initState() {
    BlocProvider.of<NDTLPTBloc>(
      context,
    ).add(NDTLPTPageLoadEvent(context: context));
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarWidget(boolLeading: true, title: AppString.nDTLPT),
      body: BackgroundWidget(
        child: BlocBuilder<NDTLPTBloc, NDTLPTState>(
  ...
  Widget _itemBuilder({required NDTLPTLoadedDataState dataState}) {
    return Column(
      children: [
        Padding(
  ...
  Widget _searchTextField({required NDTLPTLoadedDataState dataState}) {
  ...
  Widget _dataTableWidget({required NDTLPTLoadedDataState dataState}) {
                                ...
                                if (selected!) {
                                  showCupertinoDialog(
                                    ...
                                    builder: (_) => CustomCupertinoDialog(
                                      onReject: () {
                                        BlocProvider.of<NDTLPTBloc>(context).add(
