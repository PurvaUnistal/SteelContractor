...
part 'clearing_grading_event.dart';

part 'clearing_grading_state.dart';

class ClearingGradingBloc
    extends Bloc<ClearingGradingEvent, ClearingGradingState> {
  ClearingGradingBloc() : super(ClearingGradingInitial()) {
  ...
  _activityApproved(ActivityApprovedEvent event, emit) async {
    return ClearingGradingHelper.showConfirmationDialog(
  ...
  _eventCompleted(Emitter<ClearingGradingState> emit) {
    emit(
