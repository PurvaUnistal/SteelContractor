...
class ClearingGradingPage extends StatefulWidget {
  const ClearingGradingPage({super.key});
...
class _ClearingGradingPageState extends State<ClearingGradingPage> {
  ...
  @override
  void initState() {
    BlocProvider.of<ClearingGradingBloc>(
      context,
    ).add(ClearingGradingPageLoadEvent(context: context));
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarWidget(boolLeading: true, title: AppString.clearingGrading),
      body: BackgroundWidget(
        child: BlocBuilder<ClearingGradingBloc, ClearingGradingState>(
          builder: (context, state) {
            if (state is ClearingGradingLoadedDataState) {
  ...
  Widget _itemBuilder({required ClearingGradingLoadedDataState dataState}) {
    return Column(
      children: [
        Padding(
  ...
  Widget _searchTextField({required ClearingGradingLoadedDataState dataState}) {
  ...
  Widget _dataTableWidget({required ClearingGradingLoadedDataState dataState}) {
