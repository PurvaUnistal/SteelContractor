...
abstract class MarkerInstallationState extends Equatable {
  const MarkerInstallationState();
}

final class MarkerInstallationInitial extends MarkerInstallationState {
  @override
  List<Object> get props => [];
}

class MarkerInstallationPageLoadState extends MarkerInstallationState {
  @override
  List<Object> get props => [];
}

class MarkerInstallationLoadedDataState extends MarkerInstallationState {
  final bool isLoader;
