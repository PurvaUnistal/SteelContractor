...
import 'package:steel_contractor/features/MarkerInstallation/domain/bloc/marker_installation_event.dart';
import 'package:steel_contractor/features/MarkerInstallation/domain/bloc/marker_installation_state.dart';

class MarkerInstallationPage extends StatefulWidget {
  const MarkerInstallationPage({super.key});

  @override
  State<MarkerInstallationPage> createState() => _MarkerInstallationPageState();
}

class _MarkerInstallationPageState extends State<MarkerInstallationPage> {
  ScrollController _horizontalScrollController = ScrollController();
  ScrollController _verticalScrollController = ScrollController();

  @override
  void initState() {
    BlocProvider.of<MarkerInstallationBloc>(
      context,
    ).add(MarkerInstallationPageLoadEvent(context: context));
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarWidget(boolLeading: true, title: AppString.markerInstallation),
      body: BackgroundWidget(
        child: BlocBuilder<MarkerInstallationBloc, MarkerInstallationState>(
          builder: (context, state) {
            if (state is MarkerInstallationLoadedDataState) {
  ...
  Widget _itemBuilder({required MarkerInstallationLoadedDataState dataState}) {
    return Column(
      children: [
        Padding(
  ...
  Widget _searchTextField({required MarkerInstallationLoadedDataState dataState}) {
  ...
  Widget _dataTableWidget({required MarkerInstallationLoadedDataState dataState}) {
                                ...
                                if (selected!) {
                                  showCupertinoDialog(
                                    ...
                                    builder: (_) => CustomCupertinoDialog(
                                      onReject: () {
                                        BlocProvider.of<MarkerInstallationBloc>(context).add(
