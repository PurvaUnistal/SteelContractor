...
import 'package:steel_contractor/features/Lowering/domain/bloc/lowering_event.dart';
import 'package:steel_contractor/features/Lowering/domain/bloc/lowering_state.dart';

class LoweringPage extends StatefulWidget {
  const LoweringPage({super.key});

  @override
  State<LoweringPage> createState() => _LoweringPageState();
}

class _LoweringPageState extends State<LoweringPage> {
  ScrollController _horizontalScrollController = ScrollController();
  ScrollController _verticalScrollController = ScrollController();

  @override
  void initState() {
    BlocProvider.of<LoweringBloc>(
      context,
    ).add(LoweringPageLoadEvent(context: context));
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarWidget(boolLeading: true, title: AppString.lowering),
      body: BackgroundWidget(
        child: BlocBuilder<LoweringBloc, LoweringState>(
          builder: (context, state) {
            if (state is LoweringLoadedDataState) {
  ...
  Widget _itemBuilder({required LoweringLoadedDataState dataState}) {
    return Column(
      children: [
        Padding(
  ...
  Widget _searchTextField({required LoweringLoadedDataState dataState}) {
  ...
  Widget _dataTableWidget({required LoweringLoadedDataState dataState}) {
                                ...
                                if (selected!) {
                                  showCupertinoDialog(
                                    ...
                                    builder: (_) => CustomCupertinoDialog(
                                      onReject: () {
                                        BlocProvider.of<LoweringBloc>(context).add(
