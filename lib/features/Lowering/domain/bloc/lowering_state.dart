...
abstract class LoweringState extends Equatable {
  const LoweringState();
}

final class LoweringInitial extends LoweringState {
  @override
  List<Object> get props => [];
}

class LoweringPageLoadState extends LoweringState {
  @override
  List<Object> get props => [];
}

class LoweringLoadedDataState extends LoweringState {
  final bool isLoader;
