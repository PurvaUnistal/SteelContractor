...
abstract class LoweringEvent extends Equatable {}


class LoweringPageLoadEvent extends LoweringEvent {
  final BuildContext context;
  LoweringPageLoadEvent({required this.context});
  @override
  // TODO: implement props
  List<Object> get props => [context];
}

class SearchBpNumberEvent extends LoweringEvent {
  final BuildContext context;
...
class LoadMoreTableEvent extends LoweringEvent {
  final BuildContext context;
  ...
  class SelectAllCheckBoxEvent extends LoweringEvent {
...
class SelectRowIdCheckBoxEvent extends LoweringEvent {
  final String itemId;
  final bool isSelected;
  final BuildContext context;
...
class ActivityApprovedEvent extends LoweringEvent {
  final BuildContext context;
...
class ActivityRejectEvent extends LoweringEvent {
  final BuildContext context;
...
class DownloadPdfEvent extends LoweringEvent {
  final String url;
  final BuildContext context;
...
class ImageViewEvent extends LoweringEvent {
  final String url;
  final BuildContext context;
...
class SelectTpiEvent extends LoweringEvent {
