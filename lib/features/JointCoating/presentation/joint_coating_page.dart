...
import 'package:steel_contractor/features/JointCoating/domain/bloc/joint_coating_event.dart';
import 'package:steel_contractor/features/JointCoating/domain/bloc/joint_coating_state.dart';

class JointCoatingPage extends StatefulWidget {
  const JointCoatingPage({super.key});
...
class _JointCoatingPageState extends State<JointCoatingPage> {
  ...
  @override
  void initState() {
    BlocProvider.of<JointCoatingBloc>(
      context,
    ).add(JointCoatingPageLoadEvent(context: context));
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarWidget(boolLeading: true, title: AppString.jointCoating),
      body: BackgroundWidget(
        child: BlocBuilder<JointCoatingBloc, JointCoatingState>(
          builder: (context, state) {
            if (state is JointCoatingLoadedDataState) {
  ...
  Widget _itemBuilder({required JointCoatingLoadedDataState dataState}) {
    return Column(
      children: [
        Padding(
  ...
  Widget _searchTextField({required JointCoatingLoadedDataState dataState}) {
  ...
  Widget _dataTableWidget({required JointCoatingLoadedDataState dataState}) {
                                ...
                                if (selected!) {
                                  showCupertinoDialog(
                                    ...
                                    builder: (_) => CustomCupertinoDialog(
                                      onReject: () {
                                        BlocProvider.of<JointCoatingBloc>(context).add(
