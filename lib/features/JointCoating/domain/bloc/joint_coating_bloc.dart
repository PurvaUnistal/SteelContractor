...
import 'package:steel_contractor/features/JointCoating/helper/joint_coating_helper.dart';
import 'package:url_launcher/url_launcher.dart';

class JointCoatingBloc
    extends Bloc<JointCoatingEvent, JointCoatingState> {
  JointCoatingBloc() : super(JointCoatingInitial()) {
  ...
  _pageLoad(JointCoatingPageLoadEvent event, emit) async {
  ...
  _submit({
    ...
    try {
      var res = await JointCoatingHelper.saveActivityApproveReject(
        context: context,
        status: status,
        remark: remark,
      );
  ...
  _activityApproved(ActivityApprovedEvent event, emit) async {
    return JointCoatingHelper.showConfirmationDialog(
