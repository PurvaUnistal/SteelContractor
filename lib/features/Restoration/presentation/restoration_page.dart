...
class _RestorationPageState extends State<RestorationPage> {
  ...
  @override
  void initState() {
    BlocProvider.of<RestorationBloc>(context).add(RestorationPageLoadEvent(context: context));
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBarWidget(
            boolLeading: true,title: AppString.restoration),
        body: BackgroundWidget(
          child:  BlocBuilder<RestorationBloc, RestorationState>(
            builder: (context, state) {
              if (state is RestorationLoadedDataState) {
  ...
  Widget _itemBuilder({required RestorationLoadedDataState dataState}) {
    return Column(
      children: [
        Padding(
  ...
  Widget _searchTextField({required RestorationLoadedDataState dataState}) {
    return TextFieldWidget(
      ...
      onChanged: (val) {
        BlocProvider.of<RestorationBloc>(context).add(SearchBpNumberEvent(
          context: context,
          searchBpNumber: val,
        ));
      },
  ...
  Widget _dataTableWidget({required RestorationLoadedDataState dataState}) {
                      ...
                      CommonStyle.dataCheckBox(
                        widget: Checkbox(
                          ...
                          onChanged: (bool? selected) {
                            if (selected!) {
                              showCupertinoDialog(
                                ...
                                builder: (_) => CustomCupertinoDialog(
                                  onReject: () {
                                    BlocProvider.of<RestorationBloc>(context).add(
                            ...
                            BlocProvider.of<RestorationBloc>(
                              context,
                            ).add(
