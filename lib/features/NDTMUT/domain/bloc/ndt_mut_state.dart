...
abstract class NDTMUTState extends Equatable {
  const NDTMUTState();
}

final class NDTMUTInitial extends NDTMUTState {
  @override
  List<Object> get props => [];
}

class NDTMUTPageLoadState extends NDTMUTState {
  @override
  List<Object> get props => [];
}

class NDTMUTLoadedDataState extends NDTMUTState {
  final bool isLoader;
