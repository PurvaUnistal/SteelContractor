...
import 'package:steel_contractor/features/TieIn/domain/bloc/tie_in_event.dart';
import 'package:steel_contractor/features/TieIn/domain/bloc/tie_in_state.dart';

class TieInPage extends StatefulWidget {
  const TieInPage({super.key});

  @override
  State<TieInPage> createState() => _TieInPageState();
}

class _TieInPageState extends State<TieInPage> {
  ScrollController _horizontalScrollController = ScrollController();
  ScrollController _verticalScrollController = ScrollController();

  @override
  void initState() {
    BlocProvider.of<TieInBloc>(
      context,
    ).add(TieInPageLoadEvent(context: context));
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarWidget(boolLeading: true, title: AppString.tieIn),
      body: BackgroundWidget(
        child: BlocBuilder<TieInBloc, TieInState>(
          builder: (context, state) {
            if (state is TieInLoadedDataState) {
  ...
  Widget _itemBuilder({required TieInLoadedDataState dataState}) {
    return Column(
      children: [
        Padding(
  ...
  Widget _searchTextField({required TieInLoadedDataState dataState}) {
  ...
  Widget _dataTableWidget({required TieInLoadedDataState dataState}) {
                                ...
                                if (selected!) {
                                  showCupertinoDialog(
                                    ...
                                    builder: (_) => CustomCupertinoDialog(
                                      onReject: () {
                                        BlocProvider.of<TieInBloc>(context).add(
