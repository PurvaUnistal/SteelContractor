...
class OfcSplicingJointingPage extends StatefulWidget {
  const OfcSplicingJointingPage({super.key});

  @override
  State<OfcSplicingJointingPage> createState() => _OfcSplicingJointingPageState();
}

class _OfcSplicingJointingPageState extends State<OfcSplicingJointingPage> {
  ScrollController _horizontalScrollController = ScrollController();
  ScrollController _verticalScrollController = ScrollController();

  @override
  void initState() {
    BlocProvider.of<OfcSplicingJointingBloc>(context).add(OfcSplicingJointingPageLoadEvent(context: context));
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBarWidget(
            boolLeading: true,
            title: AppString.ofcSplicing),
        body: BackgroundWidget(
          child:  BlocBuilder<OfcSplicingJointingBloc, OfcSplicingJointingState>(
            builder: (context, state) {
              if (state is OfcSplicingJointingLoadedDataState) {
  ...
  Widget _itemBuilder({required OfcSplicingJointingLoadedDataState dataState}) {
    return Column(
      children: [
        Padding(
  ...
  Widget _searchTextField({required OfcSplicingJointingLoadedDataState dataState}) {
    return TextFieldWidget(
      ...
      onChanged: (val) {
        BlocProvider.of<OfcSplicingJointingBloc>(context).add(SearchBpNumberEvent(
          context: context,
          searchBpNumber: val,
        ));
      },
  ...
  Widget _dataTableWidget({required OfcSplicingJointingLoadedDataState dataState}) {
                            ...
                            if (selected!) {
                              showCupertinoDialog(
                                ...
                                builder: (_) => CustomCupertinoDialog(
                                  onReject: () {
                                    BlocProvider.of<OfcSplicingJointingBloc>(context).add(
