...
class RouHandoverPage extends StatefulWidget {
  const RouHandoverPage({super.key});

  @override
  State<RouHandoverPage> createState() => _RouHandoverPageState();
}

class _RouHandoverPageState extends State<RouHandoverPage> {
  ScrollController _horizontalScrollController = ScrollController();
  ScrollController _verticalScrollController = ScrollController();

  @override
  void initState() {
    BlocProvider.of<RouHandoverBloc>(context).add(RouHandoverPageLoadEvent(context: context));
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBarWidget(
            boolLeading: true, title: AppString.rouHandover),
        body: BackgroundWidget(
          child:  BlocBuilder<RouHandoverBloc, RouHandoverState>(
  ...
  Widget _itemBuilder({required RouHandoverLoadedDataState dataState}) {
    return Column(
      children: [
        Padding(
  ...
  Widget _searchTextField({required RouHandoverLoadedDataState dataState}) {
    return TextFieldWidget(
      ...
      onChanged: (val) {
        BlocProvider.of<RouHandoverBloc>(context).add(SearchBpNumberEvent(
          context: context,
          searchBpNumber: val,
        ));
      },
  ...
  Widget _dataTableWidget({required RouHandoverLoadedDataState dataState}) {
                      ...
                      CommonStyle.dataCheckBox(
                        widget: Checkbox(
                          ...
                          onChanged: (bool? selected) {
                            if (selected!) {
                              showCupertinoDialog(
                                ...
                                builder: (_) => CustomCupertinoDialog(
                                  onReject: () {
                                    BlocProvider.of<RouHandoverBloc>(context).add(
                            ...
                            BlocProvider.of<RouHandoverBloc>(
                              context,
                            ).add(
                          ...
                          cells: <DataCell>[
                            ...
                            DataCell(
                              Checkbox(
                                ...
                                onChanged: (bool? selected) {
                                  BlocProvider.of<RouHandoverBloc>(context,).add(SelectRowIdCheckBoxEvent(isSelected: selected ?? false, itemId: user.id.toString(),));
                                  if (selected!) {
                                    showCupertinoDialog(
                                      context: context,
                                      builder: (_) => CustomCupertinoDialog(
