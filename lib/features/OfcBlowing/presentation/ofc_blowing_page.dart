...
class OfcBlowingPage extends StatefulWidget {
  const OfcBlowingPage({super.key});
...
class _OfcBlowingPageState extends State<OfcBlowingPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBarWidget(
            boolLeading: true,
            title:AppString.ofcBlowing),
        body: BackgroundWidget(
          child:  BlocBuilder<OfcBlowingBloc, OfcBlowingState>(
            builder: (context, state) {
              if (state is OfcBlowingLoadedDataState) {
  ...
  Widget _itemBuilder({required OfcBlowingLoadedDataState dataState}) {
    return Column(
      children: [
        Padding(
  ...
  Widget _searchTextField({required OfcBlowingLoadedDataState dataState}) {
    return TextFieldWidget(
      ...
      onChanged: (val) {
        BlocProvider.of<OfcBlowingBloc>(context).add(SearchBpNumberEvent(
          context: context,
          searchBpNumber: val,
        ));
      },
  ...
  Widget _dataTableWidget({required OfcBlowingLoadedDataState dataState}) {
                      ...
                      CommonStyle.dataCheckBox(
                        widget: Checkbox(
                          ...
                          onChanged: (bool? selected) {
                            ...
                            BlocProvider.of<OfcBlowingBloc>(
                              context,
                            ).add(
