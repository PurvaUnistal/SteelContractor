...
abstract class CrossingState extends Equatable {
  const CrossingState();
}

final class CrossingInitial extends CrossingState {
  @override
  List<Object> get props => [];
}

class CrossingPageLoadState extends CrossingState {
  @override
  List<Object> get props => [];
}

class CrossingLoadedDataState extends CrossingState {
  final bool isLoader;
