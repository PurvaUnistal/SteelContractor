...
class SearchBpNumberEvent extends LevellingEvent {
  final BuildContext context;
...
class LoadMoreTableEvent extends LevellingEvent {
  final BuildContext context;
  ...
  class SelectAllCheckBoxEvent extends LevellingEvent {
...
class SelectRowIdCheckBoxEvent extends LevellingEvent {
  final String itemId;
  final bool isSelected;
  final BuildContext context;
...
class ActivityApprovedEvent extends LevellingEvent {
  final BuildContext context;
...
class ActivityRejectEvent extends LevellingEvent {
  final BuildContext context;
...
class DownloadPdfEvent extends LevellingEvent {
  final String url;
  final BuildContext context;
...
class ImageViewEvent extends LevellingEvent {
  final String url;
  final BuildContext context;
...
class SelectTpiEvent extends LevellingEvent {
