...
import 'package:steel_contractor/features/Levelling/helper/levelling_helper.dart';
import 'package:url_launcher/url_launcher.dart';

class LevellingBloc
    extends Bloc<LevellingEvent, LevellingState> {
  LevellingBloc() : super(LevellingInitial()) {
  ...
  _submit({
    ...
    try {
      var res = await LevellingHelper.saveActivityApproveReject(
        context: context,
        status: status,
        remark: remark,
      );
  ...
  _activityApproved(ActivityApprovedEvent event, emit) async {
    return LevellingHelper.showConfirmationDialog(
  ...
  _eventCompleted(Emitter<LevellingState> emit) {
    emit(
      LevellingLoadedDataState(
        isLoader: isLoader,
