...
class _WeldingPageState extends State<WeldingPage> {
  ...
  @override
  void initState() {
    BlocProvider.of<WeldingBloc>(
      context,
    ).add(WeldingPageLoadEvent(context: context));
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarWidget(boolLeading: true, title: AppString.welding),
      body: BackgroundWidget(
        child: BlocBuilder<WeldingBloc, WeldingState>(
          builder: (context, state) {
            if (state is WeldingLoadedDataState) {
  ...
  Widget _itemBuilder({required WeldingLoadedDataState dataState}) {
    return Column(
      children: [
        Padding(
  ...
  Widget _searchTextField({required WeldingLoadedDataState dataState}) {
  ...
  Widget _dataTableWidget({required WeldingLoadedDataState dataState}) {
