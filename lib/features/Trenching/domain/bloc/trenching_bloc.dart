...
import 'package:steel_contractor/features/Trenching/helper/trenching_helper.dart';
import 'package:url_launcher/url_launcher.dart';

part 'trenching_event.dart';

part 'trenching_state.dart';

class TrenchingBloc extends Bloc<TrenchingEvent, TrenchingState> {
  TrenchingBloc() : super(TrenchingInitial()) {
  ...
  _activityApproved(ActivityApprovedEvent event, emit) async {
    return TrenchingHelper.showConfirmationDialog(
  ...
  _eventCompleted(Emitter<TrenchingState> emit) {
    emit(
