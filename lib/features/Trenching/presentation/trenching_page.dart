...
class _TrenchingPageState extends State<TrenchingPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBarWidget(
            boolLeading: true,title: AppString.trenching),
        body: BackgroundWidget(
          child:  BlocBuilder<TrenchingBloc, TrenchingState>(
            builder: (context, state) {
              if (state is TrenchingLoadedDataState) {
  ...
  Widget _itemBuilder({required TrenchingLoadedDataState dataState}) {
    return Column(
      children: [
        Padding(
  ...
  Widget _searchTextField({required TrenchingLoadedDataState dataState}) {
    return TextFieldWidget(
      ...
      onChanged: (val) {
        BlocProvider.of<TrenchingBloc>(context).add(SearchBpNumberEvent(
          context: context,
          searchBpNumber: val,
        ));
      },
  ...
  Widget _dataTableWidget({required TrenchingLoadedDataState dataState}) {
