...
import 'package:steel_contractor/features/Hydrotest/helper/hydro_test_helper.dart';
import 'package:url_launcher/url_launcher.dart';

class HydroTestBloc extends Bloc<HydroTestEvent, HydroTestState> {
  HydroTestBloc() : super(HydroTestInitial()) {
  ...
  _submit({
    ...
    try {
      var res = await HydroTestHelper.saveActivityApproveReject(
        context: context,
        status: status,
        remark: remark,
      );
  ...
  _activityApproved(ActivityApprovedEvent event, emit) async {
    return HydroTestHelper.showConfirmationDialog(
  ...
  _eventCompleted(Emitter<HydroTestState> emit) {
    emit(
