...
import 'package:steel_contractor/features/Hydrotest/domain/bloc/hydro_test_event.dart';
import 'package:steel_contractor/features/Hydrotest/domain/bloc/hydro_test_state.dart';

class HydroTestPage extends StatefulWidget {
  const HydroTestPage({super.key});

  @override
  State<HydroTestPage> createState() => _HydroTestPageState();
}

class _HydroTestPageState extends State<HydroTestPage> {
  ScrollController _horizontalScrollController = ScrollController();
  ScrollController _verticalScrollController = ScrollController();

  @override
  void initState() {
    BlocProvider.of<HydroTestBloc>(
      context,
    ).add(HydroTestPageLoadEvent(context: context));
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarWidget(boolLeading: true, title: AppString.hydroTest),
      body: BackgroundWidget(
        child: BlocBuilder<HydroTestBloc, HydroTestState>(
          builder: (context, state) {
            if (state is HydroTestLoadedDataState) {
  ...
  Widget _itemBuilder({required HydroTestLoadedDataState dataState}) {
    return Column(
      children: [
        Padding(
  ...
  Widget _searchTextField({required HydroTestLoadedDataState dataState}) {
  ...
  Widget _dataTableWidget({required HydroTestLoadedDataState dataState}) {
