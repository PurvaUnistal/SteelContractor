...
class SearchBpNumberEvent extends BackfillingEvent {
  final BuildContext context;
...
class LoadMoreTableEvent extends BackfillingEvent {
  ...
  class SelectAllCheckBoxEvent extends BackfillingEvent {
...
class SelectRowIdCheckBoxEvent extends BackfillingEvent {
  final String itemId;
  final bool isSelected;
  final BuildContext context;
...
class DownloadPdfEvent extends BackfillingEvent {
  final String url;
  final BuildContext context;
...
class ImageViewEvent extends BackfillingEvent {
  final String url;
  final BuildContext context;
