...
import 'package:steel_contractor/features/Backfilling/helper/backfilling_helper.dart' show BackfillingHelper;
import 'package:steel_contractor/features/ClearingGrading/domain/model/ReportActivityModel.dart';
import 'package:url_launcher/url_launcher.dart';

class BackfillingBloc
    extends Bloc<BackfillingEvent, BackfillingState> {
  BackfillingBloc() : super(BackfillingInitial()) {
  ...
  _submit({
    ...
    try {
      var res = await BackfillingHelper.saveActivityApproveReject(
        context: context,
        status: status,
        remark: remark,
      );
  ...
  _activityApproved(ActivityApprovedEvent event, emit) async {
    return BackfillingHelper.showConfirmationDialog(
  ...
  _eventCompleted(Emitter<BackfillingState> emit) {
    emit(
