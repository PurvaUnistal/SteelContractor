...
abstract class ApproverActivityState extends Equatable {
  const ApproverActivityState();
}

final class ApproverActivityInitial extends ApproverActivityState {
  @override
  List<Object> get props => [];
}

class ApproverActivityPageLoadState extends ApproverActivityState {
  @override
  List<Object> get props => [];
}

class ApproverActivityLoadedDataState extends ApproverActivityState {
  final bool isLoader;
