...
class PostHydrotestPage extends StatefulWidget {
  const PostHydrotestPage({super.key});

  @override
  State<PostHydrotestPage> createState() => _PostHydrotestPageState();
}

class _PostHydrotestPageState extends State<PostHydrotestPage> {
  ScrollController _horizontalScrollController = ScrollController();
  ScrollController _verticalScrollController = ScrollController();

  @override
  void initState() {
    BlocProvider.of<PostHydrotestBloc>(context).add(PostHydrotestPageLoadEvent(context: context));
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBarWidget(
            boolLeading: true, title: AppString.postHydroTest),
        body: BackgroundWidget(
          child:  BlocBuilder<PostHydrotestBloc, PostHydrotestState>(
            builder: (context, state) {
              if (state is PostHydrotestLoadedDataState) {
  ...
  Widget _itemBuilder({required PostHydrotestLoadedDataState dataState}) {
    return Column(
      children: [
        Padding(
  ...
  Widget _searchTextField({required PostHydrotestLoadedDataState dataState}) {
    return TextFieldWidget(
      ...
      onChanged: (val) {
        BlocProvider.of<PostHydrotestBloc>(context).add(SearchBpNumberEvent(
          context: context,
          searchBpNumber: val,
        ));
      },
  ...
  Widget _dataTableWidget({required PostHydrotestLoadedDataState dataState}) {
                      ...
                      CommonStyle.dataCheckBox(
                        widget: Checkbox(
                          ...
                          onChanged: (bool? selected) {
                            if (selected!) {
                              showCupertinoDialog(
                                ...
                                builder: (_) => CustomCupertinoDialog(
                                  onReject: () {
                                    BlocProvider.of<PostHydrotestBloc>(context).add(
                            ...
                            BlocProvider.of<PostHydrotestBloc>(
                              context,
                            ).add(
